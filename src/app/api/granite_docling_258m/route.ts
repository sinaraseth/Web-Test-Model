...
const MODEL_NAME = "ibm/granite-docling:258m";
...
RULES:
- Output valid HTML ONLY (no CSS, no inline styles)
- Use semantic tags: <table>, <tr>, <th>, <td>, <h1>, <p>
- NO explanations, NO markdown, NO comments
- NO extra text like "Source:", "Note:"
